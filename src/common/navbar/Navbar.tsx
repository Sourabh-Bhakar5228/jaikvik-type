  ...
  return (
    <>
      ...
      <div
        ...
        } transition-transform duration-500 z-[1000] shadow-2xl`}
      >
        {/* Header */}
        ...
        {/* Menu Content */}
        <div className="inner customScroll flex flex-col h-full overflow-y-auto">
            ...
            <ul className="list-none m-0 p-0 space-y-1">
              ...
              <li className="language-menu">
                <button
                  ...
                  className="w-full text-left px-4 py-3 text-red-500 text-base font-medium rounded-lg border-b border-gray-700/50 hover:bg-gray-800 hover:text-red-400 transition-all duration-200"
                >
                  Language
                </button>
              </li>
            ...
            <ul className="flex space-x-3">
              <li>
                <Link
                  ...
                  className="bg-red-500 text-white w-10 h-10 rounded-full flex items-center justify-center hover:bg-red-600 hover:scale-110 transition-all duration-200"
                  target="_blank"
      ...
      >
        <div className="translate-popup-content bg-gradient-to-br from-gray-600 to-gray-100 rounded-lg p-4 w-64 shadow-2xl animate-[slideInRight_0.3s_ease-out]">
          <div className="flex justify-between items-center mb-2">
            ...
            <button
              onClick={toggleTranslateDropdown}
              className="text-xl text-gray-700 hover:text-red-500 transition-colors"
