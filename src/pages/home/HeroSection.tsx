  ...
  return (
    <section className="overflow-hidden w-full px-2.5">
      <div className="flex flex-wrap w-full justify-center">
        ...
        <div className="w-full lg:w-3/4 md:w-1/2 px-4">
          <div
          ...
          >
            ...
            <video
              ...
              loop
              playsInline
              className="w-full cursor-pointer rounded-lg shadow-lg transition-transform duration-300 group-hover:scale-[1.01]"
              preload="auto"
