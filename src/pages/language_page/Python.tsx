              ...
              <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
                ...
                <div className="mt-4 p-3 bg-gray-700 rounded">
                  <p className="text-sm text-gray-300">
                    <strong>Current version:</strong> Python 3.11 (released
                    October 2022)
                  </p>
                </div>
              </div>
                  ...
                  <li>
                    ...
                    <pre className="mt-1 bg-gray-900 p-2 rounded text-xs overflow-x-auto">
                      <code className="text-green-400">
                        # macOS (Homebrew) brew install python # Ubuntu sudo apt
                        install python3 python3-pip # Windows (Chocolatey) choco
                        install python
                      </code>
                    </pre>
                  </li>
