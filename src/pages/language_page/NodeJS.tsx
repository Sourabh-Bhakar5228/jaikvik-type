              ...
              <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
                ...
                <div className="mt-4 p-3 bg-gray-700 rounded">
                  <p className="text-sm text-gray-300">
                    <strong>Current version:</strong> Node.js 18.x (LTS as of
                    October 2022)
                  </p>
                </div>
              </div>
                  ...
                  <li>
                    ...
                    <pre className="mt-1 bg-gray-900 p-2 rounded text-xs overflow-x-auto">
                      <code className="text-green-400">
                        # macOS (Homebrew) brew install node # Ubuntu sudo apt
                        install nodejs npm # Windows (Chocolatey) choco install
                        nodejs
                      </code>
                    </pre>
                  </li>
...
*/`}
              ...
              <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
                ...
                <p className="mb-4 text-gray-300">
                  Node.js uses CommonJS modules by default (with ES modules
                  support):
                </p>
                <pre className="bg-gray-900 p-4 rounded text-sm overflow-x-auto">
                  <code className="text-green-400">
...
// ES modules (in .mjs files or with "type": "module")
// math.mjs
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
                ...
                <p className="mb-4 text-gray-300">
                  World's largest software registry with over 1.5 million
                  packages:
                </p>
                <ul className="list-disc pl-5 space-y-2 text-gray-300">
...
npm publish       # Publish package`}
              ...
              <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
                ...
                <ul className="list-disc pl-5 space-y-2 text-gray-300">
                  ...
                  <li>
                    <strong>Socket.io:</strong> Real-time framework
                  </li>
                  <li>
